#!/bin/bash
# Test hook for properly defined agents - logs all environment variables and JSON input

HOOK_LOG="hooks/test/test-player-stop-hook.log"
mkdir -p "$(dirname "$HOOK_LOG")"

echo "========================================" >> "$HOOK_LOG"
echo "[$(date -u +"%Y-%m-%dT%H:%M:%SZ")] TEST HOOK FIRED" >> "$HOOK_LOG"
echo "========================================" >> "$HOOK_LOG"
