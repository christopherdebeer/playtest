...
# This hook is only triggered by gamemaster agents (defined in .claude/agents/gamemaster.md)
# No need to check agent type since it's scoped to gamemaster
echo "[$(date -u +"%Y-%m-%dT%H:%M:%SZ")] Processing gamemaster agent $AGENT_ID" >> "$HOOK_LOG"
