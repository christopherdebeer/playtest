...
export { endGameBonusesMechanic } from './end-game-bonuses.js';
export { kingOfTheHillMechanic } from './king-of-the-hill.js';
export { victoryPointsAsResourceMechanic } from './victory-points-as-resource.js';
export { highestLowestScoringMechanic } from './highest-lowest-scoring.js';
export { finaleEndingMechanic } from './finale-ending.js';
export { singleLoserGameMechanic } from './single-loser-game.js';
