...
# Game mechanics (from mechanics/ folder - informational only)
mechanics:
  - hand-management
  - set-collection
  - take-that
...
engine_mechanics:
  ...
  # Card matching mechanic - UNO-style color/value matching
  card-matching:
    enabled: true
    matchRules:
      - { type: "color", mode: "any" }
    ...
    colorProperty: "color"
    valueProperty: "value"
    mustMatchOrDraw: true
    initialCardFromDeck: true
---
